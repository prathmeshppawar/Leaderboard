...
`;
const Hundred = () => {
  const { teams, updateTeam, updateEvent, searchEvent } = CartState();
  const [one, setOne] = useState("NA");
  const [two, setTwo] = useState("NA");
  const [three, setThree] = useState("NA");
  useEffect(() => {
    const fetchEvent = async () => {
      const fetchedEvent = await searchEvent("M100");
  ...
  const setRank = (e, state, setState, points) => {
    if (e.target.value === "NA") {
      ...
      let val = temp.mtrack - points;
      updateTeam(val, temp._id);
      ...
      let val1 = temp1.mtrack - points;
      updateTeam(val1, temp1._id);
      const temp2 = teams.find((team) => {
        return team.name === e.target.value;
      });
      let val2 = temp2.mtrack + points;
      updateTeam(val2, temp2._id);
      setState(e.target.value);
    }
  };
  return (
...
/*
  ...
  const setFirst = (e) => {
    if (e.target.value === "NA") {
      const temp = teams.find((team) => {
        return team.name === one;
      });
      let val = temp.mtrack - 10;
      updateTeam(val, temp._id);
      setOne(e.target.value);
      localStorage.setItem("M1001", JSON.stringify(e.target.value));
    } else if (one === "NA") {
      setOne(e.target.value);
      localStorage.setItem("M1001", JSON.stringify(e.target.value));
      const temp = teams.find((team) => {
      ...
      let val1 = temp1.mtrack - 10;
      updateTeam(val1, temp1._id);
      const temp2 = teams.find((team) => {
        return team.name === e.target.value;
      });
      let val2 = temp2.mtrack + 10;
      updateTeam(val2, temp2._id);
      setOne(e.target.value);
      localStorage.setItem("M1001", JSON.stringify(e.target.value));
    }
  ...
  const setSecond = (e) => {
    if (e.target.value === "NA") {
      ...
      let val = temp.mtrack - 7;
      updateTeam(val, temp._id);
      setTwo(e.target.value);
      localStorage.setItem("M1002", JSON.stringify(e.target.value));
    } else if (two === "NA") {
      setTwo(e.target.value);
      localStorage.setItem("M1002", JSON.stringify(e.target.value));
      const temp = teams.find((team) => {
      ...
      let val1 = temp1.mtrack - 7;
      updateTeam(val1, temp1._id);
      const temp2 = teams.find((team) => {
        return team.name === e.target.value;
      });
      let val2 = temp2.mtrack + 7;
      updateTeam(val2, temp2._id);
      setTwo(e.target.value);
      localStorage.setItem("M1002", JSON.stringify(e.target.value));
    }
  ...
  const setThird = (e) => {
    if (e.target.value === "NA") {
      const temp = teams.find((team) => {
        return team.name === three;
      });
      let val = temp.mtrack - 5;
      updateTeam(val, temp._id);
      setThree(e.target.value);
      localStorage.setItem("M1003", JSON.stringify(e.target.value));
    } else if (three === "NA") {
      setThree(e.target.value);
      localStorage.setItem("M1003", JSON.stringify(e.target.value));
      const temp = teams.find((team) => {
      ...
      let val1 = temp1.mtrack - 5;
      updateTeam(val1, temp1._id);
      const temp2 = teams.find((team) => {
        return team.name === e.target.value;
      });
      let val2 = temp2.mtrack + 5;
      updateTeam(val2, temp2._id);
      setThree(e.target.value);
      localStorage.setItem("M1003", JSON.stringify(e.target.value));
    }
