...
const FHundred = () => {
  ...
  useEffect(() => {
    const fetchEvent = async () => {
      const fetchedEvent = await searchEvent("F100");
...
/*
  ...
  const setFirst = (e) => {
    if (e.target.value === "NA") {
      ...
      let val1 = temp1.ftrack - 10;
      updateTeam3(val1, temp1._id);
      const temp2 = teams.find((team) => {
        return team.name === e.target.value;
      });
      let val2 = temp2.ftrack + 10;
      updateTeam3(val2, temp2._id);
      setOne(e.target.value);
      localStorage.setItem("M1001", JSON.stringify(e.target.value));
    }
  ...
  const setSecond = (e) => {
    if (e.target.value === "NA") {
      ...
      let val1 = temp1.ftrack - 7;
      updateTeam3(val1, temp1._id);
      const temp2 = teams.find((team) => {
        return team.name === e.target.value;
      });
      let val2 = temp2.ftrack + 7;
      updateTeam3(val2, temp2._id);
      setTwo(e.target.value);
      localStorage.setItem("M1002", JSON.stringify(e.target.value));
    }
  ...
  const setThird = (e) => {
    if (e.target.value === "NA") {
      ...
      let val1 = temp1.ftrack - 5;
      updateTeam3(val1, temp1._id);
      const temp2 = teams.find((team) => {
        return team.name === e.target.value;
      });
      let val2 = temp2.ftrack + 5;
      updateTeam3(val2, temp2._id);
      setThree(e.target.value);
      localStorage.setItem("M1003", JSON.stringify(e.target.value));
    }
